...
public class DLTFileLog {


    private static final  Logger logger = Logger.getLogger(DLTFileLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = folder+"/dltfile.%g.log";
    ...
    private static DLTFileLog obj=new DLTFileLog();
    
    public static DLTFileLog getInstance() {
