...
public class LogDonwloadLog {


    private static final  Logger logger = Logger.getLogger(LogDonwloadLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = folder+"/download.%g.log";
    ...
    private static LogDonwloadLog obj=new LogDonwloadLog();
    
    public static LogDonwloadLog getInstance() {
    	
    	if(obj==null) {
    		obj=new LogDonwloadLog();
    	}
