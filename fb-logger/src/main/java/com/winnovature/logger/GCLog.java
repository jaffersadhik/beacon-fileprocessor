...
public class GCLog {
    ...
    private static final  Logger logger = Logger.getLogger(GCLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = folder+"/groupconsumer.%g.log";
    ...
    private static GCLog obj=new GCLog();
    
    public static GCLog getInstance() {
