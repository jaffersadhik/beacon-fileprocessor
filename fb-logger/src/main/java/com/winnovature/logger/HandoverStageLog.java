...
public class HandoverStageLog {


    private static final  Logger logger = Logger.getLogger(HandoverStageLog.class.getName());
    ...
    private static HandoverStageLog obj=new HandoverStageLog();
    
    public static HandoverStageLog getInstance() {
    	
    	if(obj==null) {
    		obj=new HandoverStageLog();
    	}
