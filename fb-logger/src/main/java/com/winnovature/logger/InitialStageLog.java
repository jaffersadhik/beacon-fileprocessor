...
public class InitialStageLog {


    private static final  Logger logger = Logger.getLogger(InitialStageLog.class.getName());
    ...
    private static InitialStageLog obj=new InitialStageLog();
    
    public static InitialStageLog getInstance() {
    	
    	if(obj==null) {
    		obj=new InitialStageLog();
    	}
