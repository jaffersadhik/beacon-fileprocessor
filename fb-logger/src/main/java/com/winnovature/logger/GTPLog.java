...
public class GTPLog {
    ...
    private static final  Logger logger = Logger.getLogger(GTPLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = folder+"/grouptablepoller.%g.log";
    ...
    private static GTPLog obj=new GTPLog();
    
    public static GTPLog getInstance() {
